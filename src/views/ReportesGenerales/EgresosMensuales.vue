<template>
  <div class="card-header">
    <h3 class="card-title">Egresos Mensuales</h3>
  </div>
    ...
    <div class="tab-menu-heading tab-menu-heading-boxed" style="border-bottom: 0 !important">
      <div class="tabs-menu-boxed" style="float: right; width: 100%">
        ...
        <ul class="nav panel-tabs" style="float: right">
          ...
          <li>
            <a href="#registrarTab" class="active" data-bs-toggle="tab" id="tabGeneralRegistrar">Egresos Mensuales</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div class="tab-pane active" id="registrarTab">
          ...
          <div class="row">
            <div class="col-md-3 mb-3">
              <label>Desde</label>
              <input type="month" class="form-control" placeholder="Fecha Inicio" v-model="fecha_inicio" />
            </div>
            <div class="col-md-3 mb-3">
              <label>Hasta</label>
              <input type="month" class="form-control" placeholder="Fecha Inicio" v-model="fecha_fin" />
            </div>
...
export default {
  ...
  methods: {
    ...
    download_excel: async function () {
      ...
      var res = await this.EgresosMensuales(egresos_mensuales);
      ...
      if (res != null) {
        ...
        const filename = "egresosmensuales";
    ...
    cargarRegistros: async function (pagina = 1) {
      ...
      let res = await this.EgresosMensuales(egresos_mensuales);
      console.log(res);
      if (res != null) {
