<template>
  <div class="card-header">
    <h3 class="card-title">Modulo Auxiliar</h3>
  </div>
            ...
            <div class="row">
              <div class="col-md-3 mb-3" style="text-align: center">
                ...
                >
                  ...
                  <option value="nombreApellido">Nombre o Apellido</option>
...
export default {
  ...
  methods: {
    ...
    cambiarTabListar() {
      document.getElementById("tabRegistrarAuxiliar").className = "";
      document.getElementById("registrarTab").className = "tab-pane";
      document.getElementById("tabListadoAuxiliar").className = "active";
      document.getElementById("listadoTab").className = "tab-pane active";
    },
    cambiarTabRegistro() {
      document.getElementById("tabRegistrarAuxiliar").className = "active";
      document.getElementById("registrarTab").className = "tab-pane active";
      document.getElementById("tabListadoAuxiliar").className = "";
