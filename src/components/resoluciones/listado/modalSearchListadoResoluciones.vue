                        ...
                        >
                          ...
                          <td class="text-center">
                            <i
                              ...
                              role="button"
                              @click="selectColegiadoListado(item.cqfll, index)"
                            ></i>
                          </td>
                        </tr>
                      </tbody>
...
import Paginate from "../../varios/Paginate.vue";
  ...
  export default {
    name: "modalSearchListadoResoluciones",
    ...
    methods: {
      ...
      selectColegiadoListado(item) {
        this.$emit("selectColegiadoListado", item);
      },
      indexMethod(index) {
      ...
      closeModal() {
        this.$emit("closeModalSearchListado");
      },
    },
    mounted() {
